...
<form role="form" method="post" id="newitem" name="newitem" action="<?php echo R::rlink(array("m"=>"item","v"=>"add"));?>">
...
<?php endforeach; ?>
  ...
  <div class="form-group">
    ...
    <input type="text" name="title" class="form-control" id="title" placeholder="Escriba el titulo">
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1">Descripcion</label>
    <textarea type="text" name="description" class="form-control" id="description" placeholder="Escriba la descripcion"></textarea>
  </div>


  <div class="form-group">
    <label for="exampleInputEmail1">Email</label>
    <input type="email" name="email" class="form-control" id="email" placeholder="Escriba el email de contacto">
  </div>
...
<div class="row">
<div class="col-md-4">
    <input type="text" name="phone" class="form-control" id="phone" placeholder="Escriba el telefono de contacto">
</div>
<div class="col-md-4">
    <input type="text" name="phone2" class="form-control" id="phone2" placeholder="Escriba el telefono 2">
</div>
<div class="col-md-4">
    <input type="text" name="phone3" class="form-control" id="phone3" placeholder="Escriba el telefono 3">
</div>
</div>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Sitio web</label>
    <input type="text" name="website" class="form-control" id="website" placeholder="Escriba el sitio web">
  </div>
...
<div class="row">
<div class="col-md-4">
    <input type="text" name="fburl" class="form-control" id="fburl" placeholder="Facebook">
</div>
<div class="col-md-4">
    <input type="text" name="twurl" class="form-control" id="twurl" placeholder="Twitter">
</div>
<div class="col-md-4">
    <input type="text" name="gpurl" class="form-control" id="gpurl" placeholder="Google+">
</div>
</div>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" name="city" class="form-control" id="city" placeholder="Escriba la ciudad">
  </div>
  <div class="form-group">
...
<div class="row">
<div class="col-md-4">
    <input type="text" name="ext_num" class="form-control" placeholder="Num. ext">
</div>
<div class="col-md-4">
    <input type="text" name="int_num" class="form-control" placeholder="Num. int">
</div>
<div class="col-md-4">
    <input type="text" name="cp" class="form-control" id="cp" placeholder="C.P">
</div>
</div>
  </div>
...
<?php foreach($this->services as $service):?>
      <label class="checkbox-inline"><input type="checkbox" name="services[]" value="<?php echo $service->id; ?>"> <?php echo $service->name;?></label>
<?php endforeach; ?>
  </div>
        <div class="form-group">
    <label for="exampleInputEmail1">Tipo de cosina</label>
<select name="cusine_id" id="cusine_id" class="form-control" required>
    <option value="">-- SELECCIONE UN TIPO DE COSINA --</option>
